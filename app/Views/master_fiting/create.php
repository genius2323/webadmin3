...
<div class="form-container" style="max-width: 480px; margin: 0 auto;">
    ...
    <div class="content-card">
        ...
        <?php endif; ?>
        <form action="<?= site_url('masterfiting/save') ?>" method="post" autocomplete="off">
            <div class="form-group">
                <label for="name" class="form-label">Nama Fiting<span style="color:red">*</span></label>
                <input type="text" name="name" id="name" class="form-m3-input input-m3-date" required placeholder="Nama Fiting">
            </div>
            <div class="form-group">
            ...
            <div class="form-actions" style="display:flex;justify-content:flex-end;margin-top:32px;gap:10px;">
                ...
                <a href="<?= site_url('masterfiting') ?>" class="btn-logout-modern" style="background:#e53935;color:#fff;">Batal</a>
            </div>
        </form>
    </div>
</div>
