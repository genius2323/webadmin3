...
<div class="page-header-modern">
    <div>
        ...
        <div class="page-subtitle">Form untuk mengedit data user dan departemen.</div>
    </div>
</div>
<div class="card-modern">
    <form action="<?= site_url('user/update/' . $user['id']) ?>" method="post">
        <div class="form-group-modern">
            <label>Nama</label>
            <input type="text" name="nama" class="input-modern" value="<?= esc($user['nama']) ?>" required>
        </div>
        <div class="form-group-modern">
            <label>Username</label>
            <input type="text" name="username" class="input-modern" value="<?= esc($user['username']) ?>" required>
        </div>
        <div class="form-group-modern">
        ...
        <div class="form-group-modern">
            <label>No KTP</label>
            <input type="text" name="noktp" class="input-modern" value="<?= esc($user['noktp']) ?>" required>
        </div>
        <div class="form-group-modern">
            <label>Alamat</label>
            <input type="text" name="alamat" class="input-modern" value="<?= esc($user['alamat']) ?>" required>
        </div>
        <div class="form-group-modern">
            ...
            <small class="form-text-modern">Pilih satu atau lebih departemen dengan tombol on/off.</small>
        </div>
