            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    <div class="col-auto mb-3">
                        ...
                        <div class="small">Kelola seluruh data kaki di sini.</div>
                    </div>
                    <div class="col-12 col-xl-auto mb-3">
                        <a class="btn btn-sm btn-primary" href="<?= site_url('masterkaki/create') ?>">
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
                    <form method="get" class="d-flex align-items-center gap-2 mb-0">
                        <input type="text" name="search" class="form-control form-control-sm" placeholder="Cari kaki..." value="<?= esc($search ?? '') ?>" style="max-width:180px;">
                        ...
                        <?php if (!empty($search)): ?>
                            <a href="<?= site_url('masterkaki') ?>" class="btn btn-sm btn-outline-secondary d-flex align-items-center justify-content-center" title="Clear" style="height:32px; width:32px; padding:0;"><i data-feather="x"></i></a>
                        <?php endif; ?>
                    </form>
                    <form method="get" class="d-flex align-items-center gap-2 mb-0">
                                ...
                                foreach ($kaki as $row) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center" style="white-space: nowrap !important;">
                                            <a href="<?= site_url('masterkaki/edit/' . $row['id']) ?>" class="btn btn-sm btn-warning"><i data-feather="edit"></i></a>
                                            <form action="<?= site_url('masterkaki/delete/' . $row['id']) ?>" method="post" style="display:inline;">
                                                <?= csrf_field() ?>
