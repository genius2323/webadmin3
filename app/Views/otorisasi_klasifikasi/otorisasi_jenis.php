<?php
// View: app/Views/otorisasi_klasifikasi/otorisasi_jenis.php
?>
...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <h4 class="mb-3">Otorisasi Jenis</h4>
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
                <form method="get" class="d-flex align-items-center gap-2 mb-0">
                    ...
                    <?php if (!empty($search)): ?>
                        <a href="<?= site_url('otorisasi_klasifikasi/otorisasi_jenis') ?>" class="btn btn-sm btn-outline-secondary d-flex align-items-center justify-content-center" title="Clear" style="height:32px; width:32px; padding:0;"><i data-feather="x"></i></a>
                    <?php endif; ?>
                </form>
                <form method="get" class="d-flex align-items-center gap-2 mb-0">
                        ...
                        <?php if (!empty($jenis)): ?>
                            <?php foreach ($jenis as $i => $row): ?>
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <form method="post" action="<?= site_url('otorisasi_klasifikasi/otorisasi_jenis/setOtorisasiJenis') ?>">
