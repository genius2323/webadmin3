<?php
// View: app/Views/otorisasi_klasifikasi/otorisasi_voltase.php
?>
...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <h4 class="mb-3">Otorisasi Voltase</h4>
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
                <form method="get" class="d-flex align-items-center gap-2 mb-0">
                    <input type="text" name="search" class="form-control form-control-sm" placeholder="Cari voltase..." value="<?= esc($search ?? '') ?>" style="max-width:180px;">
                    ...
                    <?php if (!empty($search)): ?>
                        <a href="<?= site_url('otorisasi_klasifikasi/otorisasi_voltase') ?>" class="btn btn-sm btn-outline-secondary d-flex align-items-center justify-content-center" title="Clear" style="height:32px; width:32px; padding:0;"><i data-feather="x"></i></a>
                    <?php endif; ?>
                </form>
                <form method="get" class="d-flex align-items-center gap-2 mb-0">
                ...
                <table class="table table-bordered table-hover align-middle mb-0 table-radius">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th style="text-align:center;">Nama Voltase</th>
                    ...
                    <tbody>
                        <?php if (!empty($voltase)): ?>
                            <?php foreach ($voltase as $i => $row): ?>
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <form method="post" action="<?= site_url('otorisasi_klasifikasi/otorisasi_voltase/setOtorisasiVoltase') ?>">
                                            <input type="hidden" name="voltase_id" value="<?= $row['id'] ?>">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="4" class="text-center">Tidak ada data voltase.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
