...
<div class="container-fluid px-4">
    ...
    <div class="card animate__animated animate__fadeInUp mb-4">
        <div class="card-body">
            <h4 class="mb-3">Otorisasi Jumlah Mata</h4>
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
                <form method="get" class="d-flex align-items-center gap-2 mb-0">
                    ...
                    <?php if (!empty($search)): ?>
                        <a href="<?= site_url('otorisasi_klasifikasi/otorisasi_jumlahmata') ?>" class="btn btn-sm btn-outline-secondary d-flex align-items-center justify-content-center" title="Clear" style="height:32px; width:32px; padding:0;"><i data-feather="x"></i></a>
                    <?php endif; ?>
                </form>
                <form method="get" class="d-flex align-items-center gap-2 mb-0">
                ...
                <table class="table table-bordered table-hover align-middle mb-0 table-radius">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th style="text-align:center;">Nama Jumlah Mata</th>
                    ...
                    <tbody>
                        <?php if (!empty($jumlahmata)): ?>
                            <?php foreach ($jumlahmata as $i => $row): ?>
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <form method="post" action="<?= site_url('otorisasi_klasifikasi/otorisasi_jumlahmata/setOtorisasiJumlahMata') ?>">
                                            <input type="hidden" name="jumlahmata_id" value="<?= $row['id'] ?>">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="4" class="text-center">Tidak ada data jumlah mata.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
