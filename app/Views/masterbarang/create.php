            ...
            <div class="col-lg-10">
                <div class="card mb-4 animate__animated animate__fadeInUp">
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form action="<?= site_url('masterbarang/store') ?>" method="post" autocomplete="off">
                            <?= csrf_field() ?>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="name" class="form-label">Nama Barang <span class="text-danger">*</span></label>
                                        <input type="text" name="name" id="name" class="form-control" required placeholder="Nama Barang">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="price" id="price" class="form-control" inputmode="numeric" autocomplete="off" placeholder="Rp 0" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="stock" class="form-label">Stok <span class="text-danger">*</span></label>
                                        <input type="number" name="stock" id="stock" class="form-control" required min="0" placeholder="Stok Barang">
                                    </div>
                                </div>
                                <div class="col-md-6">
