...
<div class="customer-modern-header">
  ...
  <div>
    <div class="customer-modern-title">Tambah Customer</div>
    <div class="customer-modern-subtitle">Isi data customer baru dengan lengkap dan benar.</div>
  </div>
</div>
<form action="<?= site_url('mastercustomer/save') ?>" method="post" autocomplete="off">
  <div style="display:flex;gap:12px;flex-wrap:wrap;">
    <div style="flex:1;min-width:160px;">
      ...
      <input type="text" name="kode_customer" id="kode_customer" class="form-control" maxlength="8" required style="width:calc(8ch + 18px);min-width:120px;">
    </div>
    <div style="flex:1;min-width:160px;">
  ...
  <div class="npwp-modern-box" style="background:#f8fafc;border-radius:16px;padding:22px 18px 12px 18px;margin:28px 0 10px 0;box-shadow:0 2px 8px 0 rgba(30,41,59,0.06);">
    ...
    <div style="display:flex;gap:12px;flex-wrap:wrap;">
      <div style="flex:1;min-width:160px;">
        ...
        <input type="text" name="npwp_atas_nama" id="npwp_atas_nama" class="form-control">
      </div>
      <div style="flex:1;min-width:160px;">
        <label for="npwp_alamat">Alamat</label>
        <input type="text" name="npwp_alamat" id="npwp_alamat" class="form-control">
      </div>
    </div>
  </div>
        ...
        .then(data => {
          ...
          if (data.length === 0) {
            ...
            data.forEach(row => {
              ...
              <td>${row.kode}</td>
              <td>${row.nama}</td>
                <td style="align-items: center;"><button type="button" class="btn btn-success btn-sm pilih-sales-btn" data-kode="${row.kode}" data-nama="${row.nama}" style="display:flex;align-items:center;gap:4px;text-align:center;">
                  <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M5 13l4 4L19 7" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                  Pilih
                </button></td>
            `;
