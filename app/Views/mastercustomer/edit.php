            ...
            <form action="<?= site_url('mastercustomer/update/' . ($customer['id'] ?? '')) ?>" method="post" autocomplete="off">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <input type="text" name="kode_customer" id="kode_customer" class="form-control" maxlength="8" required placeholder="Kode Customer" value="<?= $customer['kode_customer'] ?? '' ?>">
                  </div>
                  <div class="mb-3">
                    <label for="nama_customer" class="form-label">Nama Customer <span class="text-danger">*</span></label>
                    <input type="text" name="nama_customer" id="nama_customer" class="form-control" required placeholder="Nama Customer" value="<?= $customer['nama_customer'] ?? '' ?>">
                  </div>
                  <div class="mb-3">
                    <label for="alamat" class="form-label">Alamat</label>
                    <input type="text" name="alamat" id="alamat" class="form-control" placeholder="Alamat Customer" value="<?= $customer['alamat'] ?? '' ?>">
                  </div>
                  <div class="mb-3">
                    <label for="kota" class="form-label">Kota</label>
                    <input type="text" name="kota" id="kota" class="form-control" placeholder="Kota" value="<?= $customer['kota'] ?? '' ?>">
                  </div>
                  <div class="mb-3">
                    <label for="provinsi" class="form-label">Provinsi</label>
                    <input type="text" name="provinsi" id="provinsi" class="form-control" placeholder="Provinsi" value="<?= $customer['provinsi'] ?? '' ?>">
                  </div>
                  <div class="mb-3">
                    <label for="contact_person" class="form-label">Contact Person</label>
                    <input type="text" name="contact_person" id="contact_person" class="form-control" placeholder="Contact Person" value="<?= $customer['contact_person'] ?? '' ?>">
                  </div>
                  <div class="mb-3">
                    <label for="no_hp" class="form-label">No HP <span class="text-danger">*</span></label>
                    <input type="tel" name="no_hp" id="no_hp" class="form-control" pattern="[0-9]+" inputmode="numeric" maxlength="15" autocomplete="off" placeholder="081234567890" required value="<?= $customer['no_hp'] ?? '' ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="batas_piutang" id="batas_piutang" class="form-control" inputmode="numeric" autocomplete="off" placeholder="Rp 0" required value="<?= $customer['batas_piutang'] ?? '' ?>">
                  </div>
                  <div class="card mb-3">
                    ...
                    <div class="card-body">
                      <div class="mb-2">
                        ...
                        <div class="npwp-nomor-group" style="display:flex;gap:2px;align-items:center;justify-content:left;flex-wrap:wrap;">
                          ...
                          ?>
                            <input type="tel" name="npwp_nomor[]" maxlength="1" pattern="[0-9]" inputmode="numeric" class="form-control text-center" autocomplete="off" style="width:32px;height:38px;font-size:1.1rem;padding:1px 2px;text-align:center;" value="<?= isset($customer['npwp_nomor'][$i]) ? $customer['npwp_nomor'][$i] : '' ?>">
                          <?php endfor; ?>
                        </div>
                      </div>
                      <div class="mb-3">
                        <label for="npwp_atas_nama" class="form-label">Atas Nama</label>
                        <input type="text" name="npwp_atas_nama" id="npwp_atas_nama" class="form-control" placeholder="Atas Nama NPWP" value="<?= $customer['npwp_atas_nama'] ?? '' ?>">
                      </div>
                      <div class="mb-3">
                        <label for="npwp_alamat" class="form-label">Alamat</label>
                        <input type="text" name="npwp_alamat" id="npwp_alamat" class="form-control" placeholder="Alamat NPWP" value="<?= $customer['npwp_alamat'] ?? '' ?>">
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="d-flex justify-content-end mt-3">
                <button type="submit" class="btn btn-primary">
                  <i data-feather="save" class="me-1"></i> Update Customer
                </button>
